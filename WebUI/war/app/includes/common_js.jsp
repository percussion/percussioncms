...
<% String jsProfile = request.getParameter("profile");
    if(jsProfile == null || jsProfile=="") {
      jsProfile = "3x"; //Default to jQuery 3
    }
%>
<% if(jsProfile.equals("1x")){%>
...
<script src="../jslib/profiles/2x/jquery/plugins/jquery-superfish/js/supersubs.js"></script>
...
<script src="../jslib/profiles/3x/jquery/plugins/jquery-superfish/js/supersubs.js"></script>
...
<script src="../jslib/profiles/3x/libraries/bootstrap/js/bootstrap.bundle.js"></script>
<script src="../widgets/PercDropdown.js"></script>
