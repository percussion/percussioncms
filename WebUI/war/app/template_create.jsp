...
%>
        ...
        <a href="#" id="perc-template-preview"  style="float:right">Preview</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        ...
        <csrf:form class="perc-template-pages-controls" method="post" action="template_create.jsp">
            ...
            <input type="text" title="Pages Controls Jump" autocomplete="off" name="perc-template-pages-controls-jump" class="perc-jump">
        ...
        <input list='perc-template-items-datalist' title = "Data List" id='perc-template-item-filter' autofocus />
        ...
        <h3 class="perc-site-summary-missing-unknown">Missing Unknown<!-- the stat name is used instead --></h3>
