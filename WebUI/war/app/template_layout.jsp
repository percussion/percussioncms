...
<i18n:settings lang="<%= locale %>" prefixes="perc.ui." debug="<%=debug%>"/>
    <div id="perc-layout-menu" style = 'position:relative;'>
        <table style = 'width:100%; min-width:983px'>
            <tr>
                <td style = 'width:43%; min-width:558px'>
                
                    <div id="perc-dropdown-actions-layout" style="float:left;line-height:31px;"></div>
                    <div id="perc-dropdown-view-layout" style="float:left;line-height:31px;"></div>
