...
(function($) {
    $.perc_textFilters = {
        ...
        HOSTNAME: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[^a-zA-Z0-9\-\.]/g, '' );},

        // Filter to not allow spaces
        NOSPACES: function(txt){
            if(typeof txt === 'undefined' || txt === null){return txt;}return txt.replace(/ /g, '');},

        //Filter to not allow backslashes
        NOBACKSLASH: function(txt){
            if(typeof txt === 'undefined' || txt === null){return txt;}
        ...
        IDNAMECDATA: function(txt){ if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[^a-zA-Z0-9\-\_]/g, '');},
        ...
        //        ';' (used to append jsessionid to URL)
        //        '%' (used to URL encoding/escape)
        PATH: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[\\\:\*\?\"<\>\|\#\;\%]/g, '' );},

        // This filter used for template region name.
        // The allowed characters are: alpha-numeric, '-', '.', ':' and '_'.
        ID: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;}return txt.replace( /[^a-zA-Z0-9\-\.\:\_]/g, '' );},

        // This filter used for widget name.
        // The allowed characters are: alpha-numeric, '-', '.', ':', '_' and ' ' (space).
        ID_WITH_SPACE: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[^a-zA-Z0-9\-\.\:\_ ]/g, '' );},
        ...
        ALPHA_NUMERIC: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[^a-zA-Z0-9]/g, '' );},
        DIGITS_DOT: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[^0-9\.]/g, '' );},

        // This filter is used for widget description.
        // Invalid characters: "&", "<" and ">".
        DESCRIPTION: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /[<>&]/g, '' );},
        WINDOWS_FILE_NAME: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;} return txt.replace( /\.*$/g, '' );}
    };
})(jQuery);
...
(function($) {
    $.perc_autoFillTextFilters = {
        ...
        // It autoconverts ' ' to '-'
        IDNAMECDATA: function(txt){if(typeof txt === 'undefined' || txt === null){return txt;}return txt.replace(/[:\ \.]/g, '-').replace( /[^a-zA-Z0-9\-\_]/g, '');},
