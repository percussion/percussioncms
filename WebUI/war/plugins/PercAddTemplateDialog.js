...
(function($)
{
    ...
    $.PercAddTemplateDialog = function PercNavigationManager(okCallback)
    {
        ...
        function createAddTemplateDialog(okCallback)
        {
            ...
            dialogMarkup +=             '<input class="perc_dialog_input radio-left" title="' + I18N.message("perc.ui.addTemplateDialog@EnterpageURL") + '" tabindex="0" type="radio" name="template_from" id="perc_add_template_dialog_from_url" value="from_url" checked="checked">';
            dialogMarkup +=             '<label class="perc_dialog_label" for="perc_add_template_dialog_from_url">' + I18N.message("perc.ui.addTemplateDialog@EnterpageURL") + '</label><br>';
            dialogMarkup +=             '<input class="perc_dialog_input perc_dialog_field" title="' + I18N.message("perc.ui.addTemplateDialog@EnterpageURL") + '" tabindex="0" id="url" name="url" maxlength="2048" type="text">';
            dialogMarkup +=         '</fieldset>';
            dialogMarkup +=         '<fieldset class="perc_percussion_template_field">';
            dialogMarkup +=             '<input tabindex="0" class="perc_dialog_input radio-left" title="' + I18N.message("perc.ui.addTemplateDialog@PercussionTemplates") + '"  type="radio" name="template_from" id="perc_add_template_dialog_from_percussion_templates" value="from_percussion_templates">';
            dialogMarkup +=             '<label class="perc_dialog_label" for="perc_add_template_dialog_from_percussion_templates">' + I18N.message("perc.ui.addTemplateDialog@PercussionTemplates") + '</label>';
            dialogMarkup +=             '<div class="auto-disable">';
            dialogMarkup +=                 '<select id="perc-templates-filter" tabindex="0" name="perc-templates-filter"><option value="base">Base</option><option value="resp">Responsive</option></select>';
            dialogMarkup +=             '</div>';
