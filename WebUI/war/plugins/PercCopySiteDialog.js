    ...
    function openDialog(siteName, saasSiteNames) 
    {
        ...
        function createDialog(){
            ...
            var radioButtons =   $('<div/>').
                                    append(
                                    '<div><input style="width:15px; margin-bottom:10px; margin-top:0px; " type="radio" name="share-type-buttons" class="shareTypeButtons" id="share-type-buttons-across-site" value="Share Assets across site" checked="checked" >' + 
