...
$.PercEditSectionLinksDialog = function() {
   function openDialog(sectionObj, parentPath, siteName, dlgTitle, okCallback) {
    ...
    dialog = $("<div>" +
                ...
                "<div><input type='text' aria-required='true' class='required' readonly='true' name='perc-section-link-target' id='perc-section-link-target'/><img src='../images/images/buttonEllipse.png' class='perc-button-ellipse'/></div>" +
