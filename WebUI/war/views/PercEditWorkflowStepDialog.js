    ...
    $.PercEditWorkflowStepDialog = function()
    {
        ...
        function open(isReservedStep, isUpdate, workflowStep, workflowName, previousStepName, currentStep, successCallBack, cancelCallBack)
        {
            ...
            dialog = $(" <div id='perc-workflow-addstep-dialog'>" +
                ...
                "         <div class = 'perc-required-field'>" +I18N.message("perc.ui.edit.workflow.step.dialog@Step Name") + "<br/><input maxlength = '50' required pattern='^[a-zA-Z][a-zA-Z0-9-_\\.]{1,50}$' title='4 to 50 letters or numbers' name='perc-wfstep-name' id='perc-wfstep-name' class = '" +
                className +
                "' type='text'" +
                isreadOnly +
                "/></div>" +
