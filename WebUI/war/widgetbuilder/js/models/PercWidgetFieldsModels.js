...
(function($)
{
    WidgetBuilderApp.Field = Backbone.Model.extend({
        ...
        validate:function(oldName){
            ...
            {
            	errors.push({name:"name",message: nameVal + " is a SQL Reserved Keyword. Please choose another value. See <a href='https://percussioncmshelp.intsof.com/percussion-cm1/developers/widget-builder/widget-builder-reserved-field-names/index' title='Widget Builder Reserved Words' target='_blank' rel='noopener noreferrer'>the Help website</a> for a complete list of reserved keywords."});
            }
            else
            {
                var char1 = nameVal[0];
