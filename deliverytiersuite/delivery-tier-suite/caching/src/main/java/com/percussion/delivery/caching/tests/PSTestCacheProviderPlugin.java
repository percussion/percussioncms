...
public class PSTestCacheProviderPlugin implements IPSCacheProviderPlugin
{
    ...
    /* (non-Javadoc)
     * @see com.percussion.delivery.caching.IPSCacheProviderPlugin#invalidate(com.percussion.delivery.caching.data.PSCacheRegion, com.percussion.delivery.caching.data.PSInvalidateRequest)
     */
