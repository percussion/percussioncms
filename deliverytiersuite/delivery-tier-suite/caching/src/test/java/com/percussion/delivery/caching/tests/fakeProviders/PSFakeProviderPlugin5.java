 ...
 *
 */
public class PSFakeProviderPlugin5 implements IPSCacheProviderPlugin
{
    public PSFakeProviderPlugin5()
    {
        throw new RuntimeException("Fake exception at plugin instantiation");
    }
