 ...
 *
 */
public class PSFakeProviderPlugin6 implements IPSCacheProviderPlugin
{
    public PSFakeProviderPlugin6()
    {
    ...
    {
        throw new RuntimeException("Fake exception at plugin initialization");
    }
