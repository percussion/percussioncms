 ...
 *
 */
public class PSFakeProviderPlugin9 implements IPSCacheProviderPlugin
{
    public PSFakeProviderPlugin9()
    {
    ...
    {
        throw new RuntimeException("fake exception in 'invalite' method");
    }
