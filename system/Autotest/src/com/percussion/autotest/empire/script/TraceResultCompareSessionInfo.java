/*[ TraceResultCompareSessionInfo.java ]***************************************
 *
...
public class TraceResultCompareSessionInfo extends TraceResultCompare
{
   ...
   public String readFilteredLine(BufferedReader reader) throws java.io.IOException
   {
      ...
      // see if starting a node
      if (line.toLowerCase().indexOf("<psxusercontextextractor>") > -1)
         inNode = true;
      // see if in a node
      else if (inNode)
      {
         // read till hit end node
   ...
   public static void main(String[] args)
   {
      ...
      try
      {
         ...
         // create the object
         TraceResultCompareSessionInfo compareResult = new TraceResultCompareSessionInfo();
   ...
   /**
    * tracks if currently reading lines within a <PSXUserContextExtractor> node
    */
