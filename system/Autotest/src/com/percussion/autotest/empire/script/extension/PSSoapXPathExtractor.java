...
import com.percussion.autotest.empire.script.IPSSoapResponseExit;
 ...
 * stream to a macro.
 */ 
public class PSSoapXPathExtractor implements IPSSoapResponseExit
{
   /**
    ...
    * result of the XPath evaluation. If the macro with the name already exists,
    * its value will be overwritten.
    *
    * @param headers The headers present in the response, may be <code>null
    * </code>.  Not modified by this method.
    *
    ...
    *
    * @throws ScriptTestErrorException If <code>params</code> is missing a
   ...
   public InputStream processResponse(Properties params, IExecutionContext ctx, 
                                      Header header, InputStream input)
