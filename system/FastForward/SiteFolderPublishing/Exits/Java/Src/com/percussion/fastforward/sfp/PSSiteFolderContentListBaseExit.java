/******************************************************************************
 *
 * [ PSSiteFolderContentListBaseExit.java ]
 *
...
import com.percussion.fastforward.managednav.PSNavReset;
      ...
      IPSResultDocumentProcessor
{
      ...
      throws PSParameterMismatchException, PSExtensionProcessingException
   {
      ...
      try
      {
               ...
               == PSServerConfiguration.SERVER_TYPE_PUBLISHING_HUB)
         {
            ...
            PSNavReset navReset = new PSNavReset();
            navReset.preProcessRequest(null, request);
         }
    ...
    * 
    * @see com.percussion.extension.IPSExtension#init(com.percussion.extension.
    *      IPSExtensionDef, java.io.File)
    */
