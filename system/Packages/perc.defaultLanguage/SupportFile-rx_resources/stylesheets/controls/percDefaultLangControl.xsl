...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:psxctl="URN:percussion.com/control" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="psxi18n" xmlns:psxi18n="urn:www.percussion.com/i18n">
 ...
 -->
	<psxctl:ControlMeta name="percDefaultLangControl" dimension="single" choiceset="none">>
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor name="percDefaultLang.css" type="css" mimetype="text/css">
				<psxctl:FileLocation>../rx_resources/widgets/percDefaultLang/css/percDefaultLang.css</psxctl:FileLocation>
				<psxctl:Timestamp/>
			</psxctl:FileDescriptor>
			<psxctl:FileDescriptor name="percDefaultLang.js" type="script" mimetype="text/javascript">
	...
	<xsl:template match="Control[@name='percDefaultLangControl']" mode="psxcontrol">
...
<div id="perc-default-lang-editor" class="perc-default-lang-editor">
    <span class="perc-table-add fa fa-plus-square"></span>
<table class="perc-table">
    <tbody>
        <tr><th>Protocol*</th><th>Site*</th><th>Language*</th><th>Region/Country</th><th>Default</th><th></th><th></th></tr>
    ...
    <tr class="hide perc-defaultlang-row" role="presentation">
        ...
        <td><select id="perc-site-list" class="perc-site-list"><!-- Sites go Here --></select></td>
	...
	<xsl:template match="Control[@name='percDefaultLangControl' and @isReadOnly='yes']" priority="10" mode="psxcontrol">
		<input type="hidden" name="{@paramName}" id="perc-content-edit-{@paramName}" value="{Value}"/>
