...
(function($)
{
    ...
    $.PercPollEditor = function()
    {
        ...
        function renderReadOnly()
        {
            ...
            var pollAnswersDataStr = $("input[name='" + pollFieldName + "']").val();
            var pollAnswersData = null;
            if($.trim(pollAnswersDataStr).length>0)
        ...
        function _attachEvents()
        {
            ...
            $("input[name='perc-poll-answer-type']").click(function(){
        ...
        {
            var pollQ = $("#perc-poll-question").val();
            if(($.trim(pollQ)).length < 1)
            {
    ...
    $.PercPollAnswerControl = function(inputType)
    {
        ...
        function getAnswerEditor(answerChoices)
        {
            ...
            answerEditorHtml.find(".delete-control").click(delete_function);
            answerEditorHtml.find(".add-control").click(add_function);
