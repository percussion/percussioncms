...
public class PSDependencyTest
{
   ...
   public void testAll() throws Exception
   {
      ...
      classList.add("com.percussion.deploy.PSDependency");
      classList.add("com.percussion.deploy.PSDependencyTest");
      ...
      File file = new File("rx_resources\\ewebeditpro\\config.xml");
