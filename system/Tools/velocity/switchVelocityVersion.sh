...
function usage()
{
	...
	echo "switchVelocityVersion.sh [-vc[2.3 or 2.2 or 2.1 or 2.0-patched or 1.6.2] | [-h]]"
...
function update23()
{
	...
	cp -f 2.3/*.jar ../../jetty/base/webapps/Rhythmyx/WEB-INF/lib/
  cp -f 2.3/config/velocity-precompile.properties ../../rxconfig/Server/
	cp -f 2.3/config/tools.xml ../../jetty/base/webapps/Rhythmyx/WEB-INF/config/velocity/
}
