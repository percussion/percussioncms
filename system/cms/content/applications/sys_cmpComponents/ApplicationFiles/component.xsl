...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="psxi18n" xmlns:psxi18n="urn:www.percussion.com/i18n" >
	...
	<xsl:include href="file:sys_cmpComponents/component_body.xsl"/>
				...
				<table width="100%" cellpadding="0" cellspacing="1" border="0">
					<tr>
						<td align="middle" width="100%" valign="top" height="100%" class="outerboxcell">
							...
							<xsl:apply-templates mode="component_mainbody"/>
							<!--   end main body slot   -->
						</td>
						<td align="middle" valign="top" width="225" height="100%" class="outerboxcell">
							<!--   start left nav slot   -->
							<!-- begin XSL -->
							<xsl:for-each select="document($relatedlinks)/*/component[@slotname='slt_sys_cmp_search']">
