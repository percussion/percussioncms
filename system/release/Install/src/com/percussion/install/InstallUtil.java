...
public class InstallUtil
{
    ...
    */
   public static void convertProject(String project, String strCurDir, String strDocDir) throws IOException
   {
      if (strCurDir == null)
      {
   ...
   public static void writePreviousVersion(String strRootDir)
   {
      ...
      try
      {
         ...
         {
            // Look in RxServices/WEB-INF/lib/rxclient.jar
            jarFile = new File(strRootDir + File.separator + RxFileManager.VERSION_JAR_FILE_PUB);
            ...
            {
               // Look in rxapp.ear/rxapp.war/WEB-INF/lib/rxserver.jar
               jarFile = new File(strRootDir + File.separator + RxFileManager.VERSION_JAR_FILE_6X);
               ...
               {
                  // Look in RxServices.war/WEB-INF/lib/rxclient.jar
                  jarFile = new File(strRootDir + File.separator + RxFileManager.VERSION_JAR_FILE_PUB_6X);
                  ...
                  {
                     // Look in RxServices.war
                     jarFile = new File(strRootDir + File.separator + RxFileManager.RXSERVICES_WAR);
                     ...
                     {
                        jar = new JarFile(jarFile);
                        jarEntry = jar.getJarEntry(RxFileManager.RXCLIENT_JAR);
   ...
   public static void upgradeRepository(String strRootDir)
   {
      ...
      try
      {
         File repPropFile = new File(strRootDir, REPOSITORY_PROPS_FILE);
