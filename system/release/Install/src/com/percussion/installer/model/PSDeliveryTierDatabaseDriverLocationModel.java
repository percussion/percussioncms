/******************************************************************************
 *
 * [ PSDeliveryTierDatabaseDriverLocationModel.java ]
 *
 ...
 */
public class PSDeliveryTierDatabaseDriverLocationModel extends RxIAModel
{
   /**
    ...
    */
   public PSDeliveryTierDatabaseDriverLocationModel(IPSProxyLocator locator)
   {
      super(locator);
   }
   ...
   {
       return PSDeliveryTierDatabaseModel.isMySql() ? true : false;
   }
   ...
   private boolean validateDriver(String driverLocation)
   {
      ...
      if (!((driverLocation == null) || (driverLocation.trim().length() == 0)))
      {
         try
         {
            ...
            {
               String driverClass = PSDeliveryTierProtocolModel.fetchDriverClass();
