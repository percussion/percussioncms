 ...
 */
public class PSDeliveryTierNewInstallDestinationModel extends RxIAModel
{
   /**
    ...
    */
   public PSDeliveryTierNewInstallDestinationModel(IPSProxyLocator locator)
   {
      super(locator);
   }
   ...
   public boolean queryEnter()
   {
      ...
      int type = PSDeliveryTierInstallOptionModel.fetchInstallType();
      
      return (type == PSDeliveryTierInstallOptionModel.INSTALL_NEW || 
            type == PSDeliveryTierInstallOptionModel.INSTALL_UPGRADE_OTHER) ?
                  true : false;
   }
   ...
   private boolean validateInstallType(String rxRoot)
   {
      ...
      if (type == PSDeliveryTierInstallOptionModel.INSTALL_NEW)
      {
         if (RxFileManager.isDTSDir(dirName))
         {
            if(PSDeliveryTierInstallServerTypeModel.getServerType() != 
                  PSDeliveryTierInstallServerTypeModel.STAGING)
            {
      ...
      else if (type == PSDeliveryTierInstallOptionModel.INSTALL_UPGRADE_OTHER)
      {
         if (!RxFileManager.isDTSDir(dirName))
         {
            guierr = RxInstallerProperties.getResources().getString(
   ...
   private void updateInstallDir(String destination)
   {
      ...
      int type = PSDeliveryTierInstallServerTypeModel.getServerType();
      if(type == PSDeliveryTierInstallServerTypeModel.STAGING)
         destination += File.separator + "Staging";
