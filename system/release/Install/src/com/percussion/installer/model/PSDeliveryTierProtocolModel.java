/******************************************************************************
 *
 * [ PSDeliveryTierProtocolModel.java ]
 *
 ...
 * (jdbc driver).
 */
public class PSDeliveryTierProtocolModel extends RxIAModel
{
   /**
    ...
    */
   public PSDeliveryTierProtocolModel(IPSProxyLocator locator)
   {
      super(locator);
    ...
    */
   public static final String DRIVER_CLASS_NAME = "jdbcDriver";
   
   /**
    * The server property
    */
   public static final String DB_SERVER_NAME = "jdbcUrl";
    ...
    */
   public static final String DSCONFIG_NAME = "datasource";
    ...
    * The schema property
    */
   public static final String SCHEMA_NAME = "db.schema";
   
   /**
    * The user Type property
    */
   public static final String USER_ID = "db.username";
