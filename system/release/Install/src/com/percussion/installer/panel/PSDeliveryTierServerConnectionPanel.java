 ...
 */
public class PSDeliveryTierServerConnectionPanel extends RxIAPanel
{
   @Override
   ...
   {
      if (m_dM == null )
         m_dM = (PSDeliveryTierServerConnectionModel) getModel();
      return m_dM;
   }
    ...
    */
   private static PSDeliveryTierServerConnectionModel m_dM  = null;
}
