...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	is installed in the "rxconfig/ContentConnector" directory. If the user has also
 	selected to install the server, then he enters the value of the Rhythmyx server
	port in the Installshield panel whose bean id is "RxPortPanelBean". The contents
	of this stylesheet is then resolved. During resolution "$W(RxPortPanelBean.rxServerPort)"
