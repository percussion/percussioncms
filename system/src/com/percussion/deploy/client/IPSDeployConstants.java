...
public interface IPSDeployConstants
{
    ...
    */
   public static final String DEPLOYMENT_ROOT = "sys_MultiServerManager";
    ...
    * value.
    */
   public static final String ARCHIVE_EXTENSION = ".pda";
   ...
   public static final String PROP_ALLOW_BUILD_MISMATCH =
      "com.percussion.deploy.allowBuildMismatch";
   ...
   public static final String PROP_CREATE_SAMPLE_ARCHIVE =
      "com.percussion.deploy.createSampleArchive";

   /**
    * The constant for default max child dependencies value, currently 2000
    */
