...
import com.percussion.deploy.objectstore.PSDescriptor;
...
public class PSDeploymentManager
{
    ...
    * {@link com.percussion.deploy.catalog.PSCataloger} class returned by a call
    ...
    *
    * @return A warning message, or <code>null</code> if there are no problems.
    *
    ...
    * @throws PSDeployException if there are any errors.
    */
   public String validateArchive(PSArchiveInfo archiveInfo,
      boolean checkArchiveRef) throws PSDeployNonUniqueException,
         PSDeployException
   {
      if (archiveInfo == null)
      ...
      try
      {
         ...
         message = respDoc.getDocumentElement().getAttribute("warning");
    ...
    * server using the {@link com.percussion.deploy.catalog.PSCataloger} class
    ...
    * the server using the {@link com.percussion.deploy.catalog.PSCataloger}
   ...
   public static ResourceBundle getBundle()
   {
      if (ms_bundle == null)
      {
         ms_bundle = ResourceBundle.getBundle(
            "com.percussion.deploy.client.PSDeployStringResources");
      }
      ...
      throws PSServerLockException, PSDeployException
   {
      try
      {
         ...
         params.put("sys_jobCategory", "deploy");
