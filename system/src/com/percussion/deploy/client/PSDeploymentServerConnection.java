...
public class PSDeploymentServerConnection
{
    ...
    * @param isPwdEncrypted true if password is encrypted
    * @param overrideLock true if server locks should be overridden
         ...
         PSServerException, PSDeployException
   {
      ...
      Runnable runnable = new Runnable()
      {
         public void run()
         {
            ...
            catch (InterruptedException | PSDeployException e)
   ...
   public void extendLock() throws PSDeployException
   {
      ...
      catch(PSAuthorizationException | PSServerLockException | PSAuthenticationFailedException | PSServerException e)
      {
         throw new PSDeployException(e);
      }
   }
    ...
    */
   public static final int DEPLOYMENT_INTERFACE_VERSION = 4;
