...
public class PSArchiveDetail implements IPSDeployComponent
{
   ...
   public int hashCode()
   {
      return m_exportDescriptor.hashCode() + m_externalDbmsMap.hashCode();
   }
   ...
   public boolean equals(Object obj)
   {
      ...
      {
         PSArchiveDetail other = (PSArchiveDetail)obj;
         if (!m_exportDescriptor.equals(other.m_exportDescriptor))
            isEqual = false;
         else if (!m_externalDbmsMap.equals(other.m_externalDbmsMap))
            isEqual = false;
      }
