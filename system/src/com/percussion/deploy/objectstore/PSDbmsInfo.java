...
public class PSDbmsInfo implements IPSDeployComponent
{
   ...
   public String getPassword(boolean encrypted)
   {
      ...
      if (!encrypted && passwordEncrypted) {
         ...
         try {
            pwd = PSEncryptor.encryptString(m_pw);
   ...
   public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException
   {
      ...
      if ( datasource == null )
      {
         ...
         try {
			...
			throw new IllegalArgumentException("Cannot find datasource",e);
		}
      }
   ...
   @Override
   public int hashCode() {
      return Objects.hash(m_driver, m_server, m_database, m_origin, m_uid, m_pw, m_connInfo);
   }
