...
public abstract class PSDependency implements IPSDeployComponent, Comparable
{
   ...
   /**
    * Sets whether this dependency is included in the package.
    *
    * @param isIncluded If <code>true</code>, the dependency is included, if
    * <code>false</code> it is not.
    *
    * @throws IllegalStateException if {@link #canBeIncludedExcluded()}
    ...
    * <code>null</code> if the dependencies have not been set on this object.
    */
   public Iterator getDependencies(int type)
   {
      Iterator deps = null;
    ...
    * <code>null</code>
    */
   public void setAncestors(Iterator ancestors)
   {
      if (ancestors == null)
         m_ancestors = null;
      else
   ...
   /**
    * Sets the type of this dependency.  If supplied type specifies
    * {@link #TYPE_LOCAL}, then this dependency will be marked as included
    * ({@link #isIncluded()} will return <code>true</code>), and if supplied
    * type specifies {@link #TYPE_SERVER} or {@link #TYPE_SYSTEM}, then it will
    * be marked as not included.
    * 
    * @param type One of the <code>TYPE_XXX</code> types.
    */
   ...
   public Object clone()
   {
      ...
      else
      {
         ...
         Iterator ancestors = m_ancestors.iterator();
         while (ancestors.hasNext())
      ...
      else
      {
         ...
         Iterator dependencies = m_dependencies.iterator();
         while (dependencies.hasNext())
         {
            PSDependency sourceDep = (PSDependency) dependencies.next();
    ...
    */
   private Set m_dependencies = null;
