...
public class PSExportDescriptor extends PSDescriptor
{
   ...
   public int hashCode()
   {
      return super.hashCode() + m_packages.hashCode() +
         m_modifiedPackageNames.hashCode() + m_missingPackageNames.hashCode() +
         new Integer(m_archiveType).hashCode();
   }
   ...
   public boolean equals(Object obj)
   {
      ...
      {
         PSExportDescriptor other = (PSExportDescriptor)obj;
         if (!super.equals(other))
            isEqual = false;
         else if (!m_packages.equals(other.m_packages))
            isEqual = false;
         else if (!m_missingPackageNames.equals(other.m_missingPackageNames))
            isEqual = false;
         else if (!m_modifiedPackageNames.equals(other.m_modifiedPackageNames))
            isEqual = false;
         else if (m_archiveType != other.getArchiveType())
            isEqual = false;
         else if (m_archiveType != other.getArchiveType())
            isEqual = false;
      }
