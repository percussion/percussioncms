...
public class PSUserDependency extends PSDeployableObject
{
    ...
    * {@link PSDependency addUserDependency} on its
   ...
   /**
    * Constant for the object type of a user dependency.
    */
   public static final String USER_DEPENDENCY_TYPE = "sys_UserDependency";
   
   /**
    * Constant for the name of the object type of a user dependency.
    */
