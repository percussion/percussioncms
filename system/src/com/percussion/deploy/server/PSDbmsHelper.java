...
public class PSDbmsHelper
{
    ...
    * @throws PSDeployException data source failed to be found
    */
    ...
    * @throws PSDeployException If we fail to get data source
    */
	private DataSourceInfo getDataSourceInfo() throws PSDeployException {
   ...
   private ResourceBundle getBundle()
   {
      if (m_bundle == null)
      {
         m_bundle = ResourceBundle.getBundle("com.percussion.deploy.server." + 
    ...
    */
   private volatile static PSDbmsHelper m_instance = null;
