...
import com.percussion.deploy.objectstore.PSLogDetail;
import com.percussion.deploy.objectstore.PSLogSummary;
import com.percussion.deploy.objectstore.PSTransactionLogSummary;
...
public class PSLogHandler
{
    ...
    * @throws PSDeployException if an error occurs.
    */
   /*   Wrong place for this test, pulls in test dependencies that then get pulled into main and not test build
