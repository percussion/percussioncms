...
public class PSImportDescriptor extends PSDescriptor
{
    ...
    * empty.
    */
   public List getImportPackageList()
   {
      return m_packages;
   }
    ...
    * 
    * @param package The package to check, may not be <code>null</code>.
    * 
   ...
   public boolean isPackageIncluded(PSDeployableElement pkg)
   {
      ...
      Iterator i = m_packages.iterator();
      while (i.hasNext() && !isIncluded)
      {
         PSImportPackage impPkg = (PSImportPackage)i.next();
   ...
   public Element toXml(Document doc)
   {
      ...
      while (pkgs.hasNext())
         root.appendChild(((PSImportPackage)pkgs.next()).toXml(doc));
    ...
    */
   boolean m_validateAncestors = true;
