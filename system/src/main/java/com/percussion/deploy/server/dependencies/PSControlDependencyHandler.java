...
public class PSControlDependencyHandler extends PSAppObjectDependencyHandler
{
   ...
   public Iterator getChildDependencies(PSSecurityToken tok, PSDependency dep)
      ...
      if (id != null)
      {
         ...
         if (child != null)
         {
            if (child.getDependencyType() != PSDependency.TYPE_SYSTEM)
   ...
   public Iterator getDependencies(PSSecurityToken tok) throws PSDeployException
   {
      ...
      // add user controls next, replacing system controls with same name
      ...
      throws PSDeployException
   {
      ...
      {
         deps.add(createControlDependency(meta, system));
      }
      ...
      boolean system) throws PSDeployException
   {
      ...
      if (meta != null)
      {
         dep = createControlDependency(meta, system);
      }
    ...
    * <code>false</code>, create a shared user control.
    * 
    * @return The control dependency, never <code>null</code>.
    */
   private PSDependency createControlDependency(PSControlMeta meta, 
      boolean isSystemDep)
   {
