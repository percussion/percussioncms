...
public class PSLegacyEncrypterTest
{
   ...
   {      
      ...
      testKey(PSLegacyEncrypter.OLD_SECURITY_KEY(), "demo");
      testKey(PSLegacyEncrypter.OLD_SECURITY_KEY(), "");
      testKey("a", "myPass");
   ...
   {
      String enc = PSLegacyEncrypter.getInstance().encrypt(pwd, key);
      assertNotEquals(pwd, enc);
      System.out.println(enc);
      assertEquals(pwd, PSLegacyEncrypter.getInstance().decrypt(enc, key));
      assertEquals(enc, PSLegacyEncrypter.getInstance().encrypt(pwd, key));
   }
   ...
   {
      byte[] convertedBytes = PSLegacyEncrypter.getInstance().toByteArray(bigInt);
      ...
      assertEquals(convertedInt, bigInt);
   }
}
